...
The exemplars here are similar to the cluster centers in k-Means method above. But unlike k-Mean, the number of exemplars are not prespecified but dsicovered on the fly. The number of exemplars is affected by the chose of the fith argument in .Affinity_Propagation, which can be "MIN", "MAX" or "MEDIAN". You may refer to [Fery, 2007](http://www.psi.toronto.edu/affinitypropagation/FreyDueckScience07.pdf)<sup>2</sup> to understand what that means.
